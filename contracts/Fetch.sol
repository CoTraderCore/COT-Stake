// Split sale between dex and sale
 ...
 */
 ...
 /**
 * @dev allow owner set new stakeClaimAble contract address
 */
 function changeStakeClaimAble(address _stakeClaimAble) external onlyOwner {
   stakeClaimAble = _stakeClaimAble;
 }

 /**
 * @dev allow owner set new stakeNonClaimAble contract address
 */
 function changeStakeNonClaimAble(address _stakeNonClaimAble) external onlyOwner {
   stakeNonClaimAble = _stakeNonClaimAble;
 }
